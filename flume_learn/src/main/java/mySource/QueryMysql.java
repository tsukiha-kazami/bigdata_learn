...
public class QueryMysql {
  ...
  QueryMysql(Context context) throws ParseException {
    ...
    this.defaultCharsetResultSet = context
        .getString("default.charset.resultset", DEFAULT_CHARSET_RESULTSET);
  ...
  private Integer getStatusDBIndex(int startFrom) {
    ...
    String dbIndex = queryOne(
        "select currentIndex from flume_meta where source_tab='" + table + "'");
    if (dbIndex != null) {
