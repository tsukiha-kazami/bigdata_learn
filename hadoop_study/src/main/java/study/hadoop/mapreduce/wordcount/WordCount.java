  ...
  */
  ...
  public int run(String[] strings) throws Exception {
    ...
    TextInputFormat.addInputPath(job, new Path(
        "file:///C:\\project\\study\\bigdata\\hadoop\\learning_data\\mapReduce\\MapReduce直播预习课件\\3、MapReduce直播2次课\\1、数据&代码资料\\1、wordCount_input\\input"));
    ...
    TextOutputFormat.setOutputPath(job, new Path(
        "file:///C:\\project\\study\\bigdata\\hadoop\\learning_data\\mapReduce\\MapReduce直播预习课件\\3、MapReduce直播2次课\\1、数据&代码资料\\1、wordCount_input\\ouput"));
    //提交job任务 等待执行完成
